...
<span class="text-darkred transform -rotate-90 font-bold absolute top-[750px]  -left-[700px] border border-lightred p-4">CURRICULUM VITAE · CURRICULUM VITAE · CURRICULUM VITAE · CURRICULUM VITAE · CURRICULUM VITAE · CURRICULUM VITAE · CURRICULUM VITAE · CURRICULUM VITAE · CURRICULUM VITAE</span>
...
<div class="content-experiences ">
  <ul class="flex flex-col gap-10 text-darkred text-lg">
    <li class="flex items-center gap-5">
      <div class="left-list-container ">
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 16 16"><path fill="#F9B29C" fill-rule="evenodd" d="M6 1a1.75 1.75 0 0 0-1.75 1.75V4H3a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.25V2.75A1.75 1.75 0 0 0 10 1zm4.25 3V2.75A.25.25 0 0 0 10 2.5H6a.25.25 0 0 0-.25.25V4zM3 5.5h10a.5.5 0 0 1 .5.5v1h-11V6a.5.5 0 0 1 .5-.5m-.5 3V13a.5.5 0 0 0 .5.5h10a.5.5 0 0 0 .5-.5V8.5H9V10H7V8.5z" clip-rule="evenodd"/></svg>
    </div>
    <div class="right-list-container flex flex-col justify-center text-d">
      <span class="date text-[1.1rem]">Jui 2024 - Aou 2024 </span>
      <span class=""><span class="">Stage</span> <span class="font-bold text-[1.5rem]">- TOMY HOUSE</span></span>
      <span class="text-[1.1rem]">Chargée de communication</span>
    </div>
    </li>
...
<div class="skills-bottom-container bg-black w-full pt-52">
  <div class="title-experiences mb-10 w-full ml-48">
  <span class="text-[5rem] relative font-bold text-darkred">
    Skills
    <span class="text-lightpink font-relation text-[3rem] absolute left-6 top-7 ">
      Logiciels
    </span>
  </span>
</div>
  <!-- Section avec défilement horizontal -->
  <section class="horizontal-scroll-section h-screen bg-black relative">
      <div class="sticky top-0 h-screen flex items-center justify-center">
        <!-- Conteneur pour les éléments défilants -->
        <div class="scroll-container flex space-x-10 w-[200vw] h-full items-center justify-start">
         
          <div class="flex w-[200vw] h-screen items-center justify-start space-x-10">
          <svg xmlns="http://www.w3.org/2000/svg" width="360" height="360" viewBox="0 0 24 24"><g fill="none" stroke="#DE3A31" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 12c0-4.243 0-6.364 1.318-7.682S7.758 3 12 3s6.364 0 7.682 1.318S21 7.758 21 12s0 6.364-1.318 7.682S16.242 21 12 21s-6.364 0-7.682-1.318S3 16.242 3 12"/><path d="M6.79 15.79V12m0 0V9.276c0-.11 0-.165.004-.211c.044-.45.4-.806.85-.85c.046-.004.101-.004.211-.004h1.303a1.895 1.895 0 1 1 0 3.789zm10.388-.737c-.164-.659-.935-1.158-1.862-1.158c-1.047 0-1.895.637-1.895 1.421c0 .785.848 1.421 1.895 1.421c1.046 0 1.895.637 1.895 1.421c0 .785-.849 1.421-1.895 1.421c-.93 0-1.704-.502-1.864-1.165"/></g></svg>
  ...
  export default {
    ...
    mounted() {
      ...
      window.addEventListener("scroll", () => {
        ...
        // Vérifiez si l'utilisateur est dans la section horizontale
        if (windowScrollY >= sectionOffsetTop && windowScrollY <= sectionOffsetTop + sectionHeight) {
          const scrollProgress = windowScrollY - sectionOffsetTop;
  
          // Calculez la largeur maximale de défilement
          const maxHorizontalScroll = scrollContainer.offsetWidth - window.innerWidth;
  
          // Limitez la valeur de défilement horizontal
          const horizontalScroll = Math.min(scrollProgress, maxHorizontalScroll);
  
          // Appliquez la transformation horizontale
          scrollContainer.style.transform = `translateX(-${horizontalScroll}px)`;
  
          // Empêchez tout décalage vertical dans cette section
          horizontalSection.style.position = "sticky";
          horizontalSection.style.top = "0";
        } else {
          // Restaurez la position normale en dehors de la section
          horizontalSection.style.position = "relative";
        }
      });
    },
  };
  ...
  height: 100vh; /* Assurez-vous que la section prend tout l'écran */
...
.scroll-container {
  display: flex;
  gap: 10px;
  transition: transform 0.1s ease-out; /* Animation fluide pour le défilement */
}

svg {
  flex-shrink: 0; /* Assurez-vous que les éléments ne rétrécissent pas */
}
  </style>
